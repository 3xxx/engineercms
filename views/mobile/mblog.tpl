  ...
  <div class="pages section">
    <div class="container">
      <div class="blog">
        <div class="row">
          <div class="col s12">
            <div class="blog-content"><img src="img/blog1.jpg" alt="">
              <div class="blog-detailt">
                <h5><a href="blog-single.html">How to create Clean Design</a></h5>
        ...
        <div class="row">
          <div class="col s12">
            <div class="blog-content"><img src="img/blog2.jpg" alt="">
              <div class="blog-detailt">
                <h5><a href="blog-single.html">Mountain Sky Trips</a></h5>
                <div class="date"><span><i class="fa fa-calendar"></i>July 22,2016</span></div>
                <p>Lorem ipsum dolor sit amet,consectetur adipisicing elit. Iste quasi sit aperiam quia voluptatem odio,facere iusto magni sunt,cumque quae,molestias temporibus ducimus repellendus!</p>
                <div class="button-default">Read More</div>
              </div>
        ...
        <div class="row">
          <div class="col s12">
            <div class="blog-content"><img src="img/blog3.jpg" alt="">
              <div class="blog-detailt">
                <h5><a href="blog-single.html">Visit the Historic Museum</a></h5>
                <div class="date"><span><i class="fa fa-calendar"></i>July 22,2016</span></div>
                <p>Lorem ipsum dolor sit amet,consectetur adipisicing elit. Iste quasi sit aperiam quia voluptatem odio,facere iusto magni sunt,cumque quae,molestias temporibus ducimus repellendus!</p>
                <div class="button-default">Read More</div>
              </div>
