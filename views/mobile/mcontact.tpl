...
<body>
  ...
  <div class="navbar-top">
    ...
    <div class="side-nav-panel-right"><a href="contact.html" class="side-nav-right"><i class="fa fa-envelope"></i></a></div>
  </div><!-- end navbar top -->
  <!-- side nav left-->
  <div class="side-nav-panel-left">
    <ul id="slide-out-left" class="side-nav side-nav-panel collapsible">
      <li class="li-top"><a href="home.html"><i class="fa fa-home"></i>Home</a></li>
      <li><a href="home-shop.html"><i class="fa fa-shopping-cart"></i>Shop</a></li>
      <li><a href="blog.html"><i class="fa fa-bold"></i>Blog</a></li>
      <li><a href="portfolio.html"><i class="fa fa-th-large"></i>Portfolio</a></li>
      <li><a href="pricing.html"><i class="fa fa-dollar"></i>Pricing</a></li>
        ...
        <div class="row">
          <div class="col s12">
            <form action="send-mail.php" class="contact-form" id="contact-form" method="post">
              <div class="form-group" id="name-field"><input type="text" class="validate" id="form-name" name="form-name" placeholder="Name" required></div>
              <div class="form-group" id="email-field"><input type="email" class="validate" id="form-email" name="form-email" placeholder="Email" required></div>
              <div class="form-group" id="subject-field"><input type="text" class="validate" id="form-subject" name="form-subject" placeholder="Subject" required></div>
              <div class="form-group" id="message-field"><textarea name="form-message" id="form-message" cols="30" rows="10" class="materialize-textarea" placeholder="Your Message" required></textarea></div>
              <div class="form-group"><button class="button-default" type="submit" id="submit" name="submit">SEND MESSAGE</button></div>
            </form>
          </div>
        </div>
      </div>
  ...
  <div class="footer">
    <div class="container">
      ...
      <div class="copyright"><span>©All Right By <a href="http://www.bootstrapmb.com/">bootstrapmb</a></span></div>
    </div>
  </div><!-- end footer -->
  <!-- scripts -->
