...
<body>
  <div class="col-lg-12">
    ...
    <div id="toolbar1" class="btn-toolbar" role="toolbar" aria-label="...">
      <div class="btn-group">
        <button type="button" data-name="cartButton" id="cartButton" class="btn btn-default" title="纳入项目内">
    ...
    <div class="form-horizontal">
      <div class="modal fade" id="modalTable">
        <div class="modal-dialog modal-lg" style="width: 80%;" id="modalDialog">
          <div class="modal-content">
            <div class="modal-header" style="background-color: #FF5722;">
              <button type="button" class="close" data-dismiss="modal">
                <span aria-hidden="true">&times;</span>
              </button>
              <h3 class="modal-title">纳入项目</h3>
            </div>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" id="history2project" onclick="history2project()">保存</button>
            </div>
          </div>
        </div>
      </div>
    ...
    $("#cartButton").click(function() {
      ...
      // }
      $("label#info").remove();
      $("#history2project").removeClass("disabled")
      $('#modalTable').modal({
        show: true,
        backdrop: 'static'
      });
  ...
  $(function() {
    ...
    function operateFormatter(value, row, index) {
      return [
        ...
        '</a>',
        '<a class="cart btn btn-xs btn-warning" style="margin-left:10px" href="javascript:void(0)" title="纳入项目">',
        '<i class="fa fa-shopping-cart"></i>',
        '</a>'
      ].join('');
    }

    // fa-sign-in fa-terminal
    window.operateEvents = {
      ...
      'click .pdf': function(e, value, row, index) {
        // var url = '/v1/wx/getmathpdf?pdflink=' + row.pdfurl
        var url = '/v1/wx/getmathpdf/' + row.ID
        window.open(url, "_blank", "")
    ...
    function setPdf(value, row, index) {
      // console.log(value)
      // pdfUrl = '<a href=/v1/wx/getmathpdf?pdflink=' + value + ' title="打开pdf" target="_blank"><i class="fa fa-file-pdf-o fa-lg text-danger"></i></a>';
      pdfUrl = '<a href=/v1/wx/getmathpdf/' + row.ID + ' title="打开pdf" target="_blank"><i class="fa fa-file-pdf-o fa-lg text-danger"></i></a>';
      return pdfUrl;
    }
    ...
    function history2project() {
      ...
      $.ajax({
        type: "post",
        url: "/v1/passproject/mathhistopassproject",
        data: { ids: ids, treeids: treeids, treenodeids: treenodeids },
        success: function(data, status) {
