  ...
  <div class="collapse navbar-collapse" id="target-menu">
    <ul class="nav navbar-nav">
      ...
      <li {{if .IsMath}} class="active" {{end}}>
        <a href="/v1/mathcad/getmath/26997" title="Mathcad" target="_blank">Mathcad</a>
      </li>
      <li {{if .IsAnsys}} class="active" {{end}}>
        <a href="/v1/ansys/getansys/27004" title="Ansys" target="_blank">Ansys</a>
      </li>
      <li {{if .IsExcel}} class="active" {{end}}>
        <a href="/v1/excel/getexcel/27011" title="Excel" target="_blank">Excel</a>
      </li>
    </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="/v1/wx/getapplyrecharge" title="查看充值申请">&nbsp; 充值</a></li>
