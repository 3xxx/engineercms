                    ...
                    <div class="form-right">
                        <label>
                            <a href="#" onclick="return false;" data-toggle="modal" data-target="#upload-logo-panel">
                                <img src="{{cdnimg .Member.Avatar}}" onerror="this.src='{{cdnimg "static/mindoc/images/middle.gif"}}'" class="img-circle" alt="{{i18n .Lang "uc.avatar"}}" style="max-width: 120px;max-height: 120px;" id="headimgurl">
                            </a>
                        </label>
                    </div>
                </div>
    ...
    $(function () {
        ...
        try {
            var uploader = WebUploader.create({
                auto: false,
                swf: '/static/mindoc/webuploader/Uploader.swf',
