            ...
            <div class="article_title">
              ...
              <h1>
                <span class="link_title">
                  {{.Diary.Diarydate}}-{{.Diary.Title}}
                  <a href="/htmltodoc/{{.Diary.Id}}" class="btn btn-warning btn-xs">导出</a>
                </span>
              </h1>
            </div>
            <div class="article_bar clearfix">
              <small>发表于：{{dateformat .Diary.Created "2006-01-02 15:04:05"}}</small>
