...
<head>
    ...
    <title>{{i18n $.Lang "blog.summary"}} - 111Powered by MinDoc</title>
                    ...
                    <div class="dashboard">
                        <div class="pull-left" style="width: 200px;margin-bottom: 15px;">
                            <div class="book-image">
                                <img src="{{cdnimg .Model.Cover}}" onerror="this.src='{{cdnimg "/static/mindoc/images/book.jpg"}}'" style="border: 1px solid #666;width: 175px;">
                            </div>
                        </div>
...
<script src="{{cdnjs "/static/mindoc/layer/layer.js"}}"></script>
