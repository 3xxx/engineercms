...
<script src="{{cdnjs "/static/mindoc/js/dingtalk-jsapi.js"}}" type="text/javascript"></script>
<script src="{{cdnjs "/static/mindoc/js/dingtalk-ddlogin.js"}}" type="text/javascript"></script>
