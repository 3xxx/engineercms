<!DOCTYPE html>
<!-- saved from url=(0067)https://kitware.github.io/vtk-js/examples/GeometryViewer/index.html -->
<html>
...
<body style="margin: 0px; padding: 0px;">
  <div class="content GeometryViewer-module-fullScreen_RWlQz">
    <div>
      <div class="GeometryViewer-module-bigFileDrop_taNXL"><input type="file" multiple="" accept=".vtp" style="display: none;"></div>
    </div>
  </div>
