...
<html style="height: 100%;">
    ...
    <script type="text/javascript">
      ...
      $("#insertImage").click(function(event) {    
          ...
          docEditor.insertImage({
              "fileType": "png",
              "url": "https://bjys.itdos.com/attachment/20190728测试上传文件名修改/2020January/1580363537940306800_small.png"
          });
      })
      ...
      var onRequestHistory = function() {
        ...
        var previousUrl="";
            ...
            break;
				...
				var changeUrl2="https://bjys.itdos.com"+changeUrl.replace(/\u0026/,"&");
				// alert(changeUrl2);
        var previousurl="https://bjys.itdos.com"+previousUrl
        // alert(previousurl);
        var fileurl="https://bjys.itdos.com"+fileUrl
        // alert(fileurl);
    		docEditor.setHistoryData({
    			//下面这里存变化的位置
      		// "changesUrl":"https://bjys.itdos.com:8080/cache/files/1522475922103673500_7157/changes.zip/changes.zip?md5=syFUueSXdnCWe60Iym001g==&expires=1525068326&disposition=attachment&ooname=output.zip",//string1, //the changesUrl from the JSON object returned after saving the document
      		"changesUrl":changeUrl2,
      		"key": key,
      		"previous": {
      		  "key": previousKey,//这里不影响版本切换。与上个版本对比
      		  "url": previousurl//previousUrl//https://bjys.itdos.com:8080/cache/files/1521953170330601700_4540/output.docx/output.docx?md5=eSwnrSSumTeMuh59IoXhCQ==&expires=1524547423&disposition=attachment&ooname=output.docx这里影响版本
      		},
      		"url": fileurl,//fileUrl,
      		"version": version
    		})
        ...
        "events": {
          ...
          "title": "{{.Doc.FileName}}",
          "url": "https://bjys.itdos.com/attachment/onlyoffice/{{.Doc.FileName}}?hotqinsessionid={{.Sessionid}}",
          "info": {
            "author": "John Smith",
        ...
        "editorConfig": {
          "callbackUrl": "https://bjys.itdos.com/url-to-callback?id={{.Doc.Id}}",
          ...
          "user": {
            ...
            "customer": {
              ...
              "info": "QQ504284",
              "logo": "https://bjys.itdos.com/static/img/user.jpg",//logo-big.png
              "mail": "xc-qin@163.com",
              "name": "Qin Xiao Chuan",
              "www": "github.com/3xxx"
            },
            "feedback": {
              "url": "https://bjys.itdos.com/onlyoffice",
              "visible": true
            },
            "forcesave": false,
            "goback": {
            ...
            "logo": {
              "image": "https://bjys.itdos.com/static/img/oo.png",//logo.png
              "imageEmbedded": "https://bjys.itdos.com/static/img/oo.png",//logo_em.png
              "url": "https://bjys.itdos.com/onlyoffice"
            },
  ...
  function myAjax(json) {
    ...
    $.ajax({
      ...
      async: false,
      url: "https://bjys.itdos.com/v1/pdfcpu/test/" + "'" + codeHandler.encode(JSON.stringify(json), 'base64') + "'" + "time=" + Date.parse(new Date()),
  ...
  $("#getSignature").click(function() {
    ...
    docEditor.insertImage({
              ...
              // "url": "https://bjys.itdos.com/attachment/onlyoffice/signature/2020March/1584852817365874800.png"
          });
    // pdf合并签名，成功后reload
    // $.ajax({
    //     cache: false,
...
"url":"https://bjys.itdos.com:8080/cache/files/1521953170330601700_4540/outpu
t.docx/output.docx?md5=eSwnrSSumTeMuh59IoXhCQ==&expires=1524547423&disposition=a
ttachment&ooname=output.docx",

"changesurl":"https://bjys.itdos.com:8080/cache/fil
