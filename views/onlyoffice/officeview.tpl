...
<!-- fei-OnlyOffice -->
    ...
    <script type="text/javascript" src="http://192.168.100.37:9000/web-apps/apps/api/documents/api.js"></script>
    ...
    <script type="text/javascript">
      ...
      var Url="http://192.168.100.37/{{.FilePath}}?hotqinsessionid={{.Sessionid}}";
      ...
      // alert(Url2);
        ...
        "editorConfig": {
          "callbackUrl": "http://192.168.100.37/officeviewcallback?id={{.AttachId}}",
          "user": {
            "id": {{.Uid}},
            "name": "{{.Username}}"
          },
            ...
            "customer": {
              ...
              "info": "QQ504284",
              "logo": "http://192.168.100.37/static/img/user.jpg",//logo-big.png
              "mail": "xc-qin@163.com",
              "name": "Qin Xiao Chuan",
              "www": "github.com/3xxx"
            },
            "feedback": {
              "url": "http://192.168.100.37/onlyoffice",
              "visible": true
            },
            "forcesave": true,
            "goback": {
            ...
            "logo": {
              "image": "http://192.168.100.37/static/img/oo.png",//logo.png
              "imageEmbedded": "http://192.168.100.37/static/img/oo.png",//logo_em.png
              "url": "http://192.168.100.37/onlyoffice"
            },
