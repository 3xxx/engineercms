...
<head>
    ...
    <link href="{{cdncss "/static/mindoc/css/markdown.css" "version"}}" rel="stylesheet">
    <link href="{{cdncss "/static/mindoc/prettify/themes/atelier-estuary-dark.min.css"}}" rel="stylesheet">
    ...
    <link href="{{cdncss "/static/mindoc/quill/quill.core.css"}}" rel="stylesheet">
    <link href="{{cdncss "/static/mindoc/quill/quill.snow.css"}}" rel="stylesheet">
...
<script src="{{cdnjs "/static/mindoc/katex/katex.min.js"}}" type="text/javascript"></script>
<script src="{{cdnjs "/static/mindoc/to-markdown/dist/to-markdown.js"}}" type="text/javascript"></script>
<script src="{{cdnjs "/static/mindoc/quill/quill.js"}}" type="text/javascript"></script>
<script src="{{cdnjs "/static/mindoc/quill/quill.icons.js"}}" type="text/javascript"></script>
...
<script src="{{cdnjs "/static/mindoc/js/quill.js"}}" type="text/javascript"></script>
