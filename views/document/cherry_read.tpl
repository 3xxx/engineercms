...
<script src="{{cdnjs "/static/mindoc/bootstrap-paginator/bootstrap-paginator.min.js"}}"></script>
...
<script src="{{cdnjs "/static/mindoc/cherry/cherry-markdown.js"}}" type="text/javascript"></script>
