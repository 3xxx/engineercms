...
<head>
    ...
    <link href="{{cdncss "/static/mindoc/cherry/cherry-markdown.css" "version"}}" rel="stylesheet">
...
<script src="{{cdnjs "/static/mindoc/js/cherry_markdown.js" "version"}}" type="text/javascript"></script>
<script src="{{cdnjs "/static/mindoc/cherry/cherry-markdown.js" "version"}}" type="text/javascript"></script>
