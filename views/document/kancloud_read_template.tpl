...
<head>
    ...
    <link href="{{cdncss "/static/mindoc/jquery/plugins/imgbox/imgbox.css" "version"}}" rel="stylesheet">
...
<script src="{{cdnjs "/static/mindoc/jquery/plugins/imgbox/jquery.imgbox.pack.js"}}"></script>
