...
<body>
  ...
  function actionFormatter(value, row, index) {
    return [
      '<span><img src="/static/img/a.png" class="img-flag" width="8%"/></span>',

      '&nbsp;',
      '<span><img src="/static/img/b.png" class="img-flag" width="8%"/></span>',
      '&nbsp;',
      '<span><img src="/static/img/c.png" class="img-flag" width="8%"/></span>',
      '&nbsp;',
      '<span><img src="/static/img/aa.jpg" class="img-flag" width="10%"/></span>',
      '&nbsp;',
      '<span><img src="/static/img/bb.jpg" class="img-flag" width="10%"/></span>',
      '&nbsp;',
      '<span><img src="/static/img/cc.jpg" class="img-flag" width="10%"/></span>',
      '&nbsp;',
      '<span><img src="/static/img/dd.jpg" class="img-flag" width="10%"/></span>',
      '&nbsp;',
      '<span><img src="/static/img/ee.jpg" class="img-flag" width="10%"/></span>',
      '&nbsp;',
      '<span><img src="/static/img/ff.jpg" class="img-flag" width="10%"/></span>',
      '&nbsp;',
      '<span><img src="/static/img/gg.jpg" class="img-flag" width="10%"/></span>',
      '&nbsp;',
  ...
  function actionFormatter1(value, row, index) {
    return [
      '<span><img src="/static/img/01.png" class="img-flag" width="4.5%"/></span>',
      '&nbsp;',
      '<span><img src="/static/img/02.png" class="img-flag" width="6%"/></span>',
      '&nbsp;',
      '<span><img src="/static/img/03.png" class="img-flag" width="6%"/></span>',
      '&nbsp;',
  ...
  <div class="col-lg-12">
    ...
    <table id="table0" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-toolbar="#toolbar1" data-query-params="queryParams" data-sort-name="ProjectName" data-sort-order="desc" data-page-size="5" data-page-list="[5, 25, 50, All]" data-unique-id="id" data-pagination="true" data-side-pagination="client" data-single-select="true" data-click-to-select="true">
      <thead>
        <tr>
          <!-- radiobox data-checkbox radio="true"-->
          <th data-width="5" data-checkbox="true">选择</th>
          <th data-formatter="index1" data-width="5" data-align="center" data-valign="middle">#</th>
          <th data-field="Title" data-width="20" data-align="center" data-valign="middle">项目编号</th>
          <th data-field="Content" data-width="20" data-align="center" data-valign="middle">项目名称</th>
          <th data-field="DesignStage" data-width="10" data-align="center" data-valign="middle">项目阶段</th>
          <th data-field="Tips" data-formatter="actionFormatter" data-width="80" data-align="center" data-valign="middle">资料集</th>
          <th data-field="Tips" data-formatter="actionFormatter1" data-width="80" data-align="center" data-valign="middle">成员</th>
        </tr>
      </thead>
    </table>
    ...
    <script type="text/javascript">
    /*数据json*/
    var json = [{ "Id": "1", "Title": "SL2017", "Content": "珠三角水资源配置", "DesignStage": "施工图", "Tips": [1, 2] },
      { "Id": "2", "Title": "SL2018", "Content": "广州北江引水", "DesignStage": "施工图", "Tips": [1, 2] },
      { "Id": "3", "Title": "SL2019", "Content": "揭阳引韩供水", "DesignStage": "施工图", "Tips": [1, 2] },
      { "Id": "4", "Title": "SL2020", "Content": "引韩济饶供水", "DesignStage": "施工图", "Tips": [1, 2] },
      { "Id": "5", "Title": "SL2021", "Content": "广州西江引水", "DesignStage": "施工图", "Tips": [1, 2] },
      { "Id": "6", "Title": "SL2022", "Content": "韶关南水水库供水", "DesignStage": "施工图", "Tips": [1, 2] },
      { "Id": "7", "Title": "SL2023", "Content": "河源新丰江引水", "DesignStage": "施工图", "Tips": [1, 2] }
    ];
    /*初始化table数据*/
    $(function() {
