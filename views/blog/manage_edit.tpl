...
<head>
    ...
    <script type="text/javascript">
        ...
        window.katex = { js: "{{cdnjs "/static/mindoc/katex/katex"}}",css: "{{cdncss "/static/mindoc/katex/katex"}}"};
        window.editormdLib = "{{cdnjs "/static/mindoc/editor.md/lib/"}}";
        window.editor = null;
    ...
    <link href="{{cdncss "/static/mindoc/editor.md/css/editormd.css" "version"}}" rel="stylesheet">
...
<script src="{{cdnjs "/static/mindoc/editor.md/editormd.min.js" "version"}}" type="text/javascript"></script>
...
<script src="{{cdnjs "/static/mindoc/js/blog.js" "version"}}" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
