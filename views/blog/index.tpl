...
<head>
    ...
    <link href="{{cdncss "/static/mindoc/editor.md/lib/mermaid/mermaid.css"}}" rel="stylesheet">
    <link href="{{cdncss "/static/mindoc/editor.md/lib/sequence/sequence-diagram-min.css"}}" rel="stylesheet">
    <link href="{{cdncss "/static/mindoc/css/kancloud.css" "version"}}" rel="stylesheet">
    <link href="{{cdncss "/static/mindoc/editor.md/css/editormd.preview.css"}}" rel="stylesheet">
    ...
    <link href="{{cdncss "/static/mindoc/css/print.css"}}" media="print" rel="stylesheet">
