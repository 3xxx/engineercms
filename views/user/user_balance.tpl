  ...
  <div class="page-container">
    ...
    <div class="main-content" style="">
      ...
      <div class="sites-list" style="margin-bottom: 8.5rem;">
        ...
        <h4 class="text-gray" style="display: inline-block;"><i class="icon-io-tag" style="margin-right: 27px;" id="balance"></i>余额表</h4>
        <div class="row">
      ...
      $('#table0').bootstrapTable({
        ...
        columns: [{
          ...
          },
          {
            ...
            field: 'amount', //这里用user数据库json字段，不能是username
            title: '余额（元）',
            valign: 'middle',
            align: 'center',
            sortable: 'true',
