...
<body>
  <div class="col-lg-12">
        ...
        success: function(data, status) {
          ...
          $("#table").bootstrapTable({
            ajax: function(request) {
              $.ajax({
                type: "GET",
                url: "/v1/wx/businessmonthcheck31/"+data.rows[0].Id+"?&year=" + b + "&month=" + d,
    ...
    function activity() {
      ...
      $.ajax({
        type: "GET",
        url: "/v1/wx/businessmonthcheck31/"+vs+"?year=" + b + "&month=" + d,
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        data: { page: 1, limit: 500 },
        json: 'callback',
    ...
    function getColumns() {//试验
      // 加载动态表格
      $.ajax({
        url: '/v1/wx/businessmonthcheck31?year=2019&month=04',
        type: 'get',
        dataType: "json",
        async: false,
