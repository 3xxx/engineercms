...
<body>
  <div id="editor" class="col-xs-12 col-sm-12 col-lg-8 col-md-8 col-md-offset-2">
    ...
    <div class="form-group">
      <label>标题:</label>
      <input id="title" name="title" type="text" class="form-control" placeholder="Enter Titile" value="{{.article.Title}}"></div>
    <div class="form-group">
      <label>副标题:</label>
...
<!--   <script type="text/javascript" src="/static/froala/js/codemirror.min.js"></script>
  ...
  $.FroalaEditor.DefineIcon('imageAlign2', {NAME: 'info', SVG_KEY: 'help'});
  $.FroalaEditor.RegisterCommand('imageAlign2', {
    title: 'Info',
    icon: 'star',
    focus: false,
    undo: false,
    ...
    callback: function () {
      ...
      // $img.setAttribute("style", "max-height:25rem");
  ...
  $.FroalaEditor.RegisterCommand('my_dropdown', {
    ...
    //超大屏幕
    var toolbarButtons = ['fullscreen', 'bold', 'italic', 'underline', 'strikeThrough', 'subscript', 'superscript', 'fontFamily', 'fontSize', '|', 'color', 'emoticons', 'inlineStyle', 'paragraphStyle', '|', 'paragraphFormat', 'align', 'formatOL', 'formatUL', 'outdent', 'indent', 'quote', 'insertHR', '-', 'insertLink', 'insertImage', 'insertVideo', 'insertFile', 'insertTable', 'undo', 'redo', 'clearFormatting', 'selectAll', 'html','my_dropdown'];
    //大屏幕
    var toolbarButtonsMD = ['fullscreen', 'bold', 'italic', 'underline', 'fontFamily', 'fontSize', 'color', 'paragraphStyle', 'paragraphFormat', 'align', 'formatOL', 'formatUL', 'outdent', 'indent', 'quote', 'insertHR', 'insertLink', 'insertImage', 'insertVideo', 'insertFile', 'insertTable', 'undo', 'redo', 'clearFormatting','my_dropdown'];
    //小屏幕
    ...
    new FroalaEditor("#edit", {
      ...
      language: 'zh_cn',
      // toolbarButtons: ['bold', 'italic', 'underline', 'paragraphFormat', 'align','color','fontSize','insertImage','insertTable','undo', 'redo','my_dropdown'],
      // imageEditButtons: ['imageDisplay', 'imageAlign', 'imageInfo', 'imageRemove','imageAlign2']
    });
  ...
  function updatearticle() {
    ...
    $.ajax({
      type: "post",
      url: "/v1/mathcad/updatearticle",
      data: { aid: articleid, title:title,subtext: subtext, content: html }, //父级id
      success: function(data, status) {
        alert("修改“" + data + "”成功！(status:" + status + ".)");
        window.location.href = "/v1/mathcad/matharticle/" + {{.article.ID }};
      },
    });
  }
  </script>
