  ...
  $(function() {
    ...
    $(function() {
      ...
      $("#table0").bootstrapTable({
        url: '/v1/excel/getexcelhistory/{{.ExcelID}}',
        method: 'get',
        search: 'true',
        classes: "table table-striped", //这里设置表格样式
        showRefresh: 'true',
    ...
    window.operateEvents = {
      'click .cal': function(e, value, row, index) {
        var url = '/v1/excel/getexcelhistorycal/'+row.ID+'?excelid='+{{.ExcelID}}
        window.open(url,"_blank","")
      },
      'click .pdf': function(e, value, row, index) {
        var url = '/v1/wx/getexcelpdf/'+row.ID
        window.open(url,"_blank","")
    ...
    function setPdf(value, row, index) {
      // console.log(value)
      pdfUrl = '<a href=/v1/wx/getexcelpdf/' + row.ID + ' title="打开pdf" target="_blank"><i class="fa fa-file-pdf-o fa-lg text-danger"></i></a>';
      return pdfUrl;
    }
