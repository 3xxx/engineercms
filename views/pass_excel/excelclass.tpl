...
<body>
  <div class="page-wrapper toggled">
    ...
    <main class="page-content">
      ...
      <div class="container-fluid">
        <iframe src="/v1/excel/getexcel/excellist/{{.Id}}" name='iframepage' id="iframepage" frameborder="0" width="100%" scrolling="no" marginheight="0" marginwidth="0" onload="this.height=800"></iframe>
      </div>
    </main>
  </div>
  ...
  $(function() {
    ...
    $('#tree').on('nodeSelected', function(event, data) {
      document.getElementById("iframepage").src = "/v1/excel/getexcel/excellist/" + data.id;
      $.ajax({
        type: "get",
