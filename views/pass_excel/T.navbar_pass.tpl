  ...
  <div class="collapse navbar-collapse" id="target-menu">
    <ul class="nav navbar-nav">
      ...
      <li {{if .IsMath}} class="active" {{end}}>
        <a href="/v1/mathcad/getmath/97" title="Mathcad" target="_blank">Mathcad</a>
      </li>
      <li {{if .IsAnsys}} class="active" {{end}}>
        <a href="/v1/ansys/getansys/103" title="Ansys" target="_blank">Ansys</a>
      </li>
      <li {{if .IsExcel}} class="active" {{end}}>
        <a href="/v1/excel/getexcel/100" title="Excel" target="_blank">Excel</a>
      </li>
    </ul>
